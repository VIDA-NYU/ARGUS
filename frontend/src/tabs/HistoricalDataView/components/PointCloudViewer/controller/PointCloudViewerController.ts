...
export class PointCloudViewerController {
    ...
    public async initialize_controller( containerRef: HTMLElement, worldPointCloudRaw: any ): Promise<void> {

        // initializing dataset
        const dataset: Dataset = await this.initialize_dataset( worldPointCloudRaw );
    ...
    public async initialize_dataset( worldPointCloudRaw: any ): Promise<Dataset> {
